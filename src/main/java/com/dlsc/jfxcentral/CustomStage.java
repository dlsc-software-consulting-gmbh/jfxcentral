...
public class CustomStage extends BorderPane {
    ...
    public CustomStage(Stage stage, Node node) {
        setContent(node);
        ...
        titleBar.getLabel().textProperty().bind(stage.titleProperty());
    ...
    class TitleBar extends HBox {
        ...
        TitleBar() {
            ...
            FontIcon maxIcon = new FontIcon(FontAwesome.WINDOW_MAXIMIZE);
            FontIcon restoreIcon = new FontIcon(FontAwesome.WINDOW_RESTORE);
            FontIcon minIcon = new FontIcon(FontAwesome.WINDOW_MINIMIZE);
            FontIcon closeIcon = new FontIcon(FontAwesome.WINDOW_CLOSE);
            FontIcon spacerIcon = new FontIcon(FontAwesome.ERASER);
            ...
            // spacer button to make sure elements on the left of the title label and elements
            // on the right of the title label occupy the same width and the title label will
            // end up in the center
            Button spacerButton = new Button();
            spacerButton.setFocusTraversable(false);
            spacerButton.setGraphic(spacerIcon);
            spacerButton.setVisible(false);

            getChildren().addAll(closeButton, spacerButton, label, minButton, maxButton);
        }
